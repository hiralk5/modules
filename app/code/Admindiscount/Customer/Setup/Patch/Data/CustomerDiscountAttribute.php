...
namespace Admindiscount\Customer\Setup\Patch\Data;
...
class CustomerDiscountAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        try {
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(CustomerMetadataInterface::ENTITY_TYPE_CUSTOMER, 'customer_discount');
