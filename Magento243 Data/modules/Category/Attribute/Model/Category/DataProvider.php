<?php
namespace Category\Attribute\Model\Category;
  
use Magento\Framework\App\Filesystem\DirectoryList;
use Magento\Framework\Controller\ResultFactory;

class DataProvider extends \Magento\Backend\App\Action
{
    /**
     * Image uploader
     *
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name', 'category_image');
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'category_image/image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'category_image/image/' . $firstName . '/' . $secondName . '/';
