...
namespace Sku\Coupon\Model\ResourceModel\Order\Grid;
...
class Collection extends CoreSalesGrid
{
    ...
    {
        // $sku_qty = $this->getTable('sales_order_item');
        // $this->getSelect()->joinLeft($sku_qty,
        //     'main_table.entity_id = sales_order_item.item_id',
        //     ['sku']
        // );
        $coupon_code = $this->getTable('sales_order');
        $this->getSelect()->joinLeft( $coupon_code,
