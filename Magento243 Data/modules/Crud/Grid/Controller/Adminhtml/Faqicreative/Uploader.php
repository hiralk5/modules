...
class Uploader extends \Magento\Backend\App\Action
{
    ...
    const IMAGE_TMP_PATH = 'faq';
 
    const IMAGE_PATH = 'faq';
    /**
     * Upload constructor.
     *
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'faq/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'faq/';
            ...
            $imageResult['url']=$media.'faq/'.$newImageName;
        } catch (\Exception $e) {
